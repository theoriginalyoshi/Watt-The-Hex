...
bool direction = true;
  ...
  while(1)
  {
											  ...
											  else if (!direction)
												{
														    ...
														    {
														     // if (direction)
														    motor[motorH] = -joystick.joy1_y2;         // Motor B is assigned a power level equal to the right analog stick's Y-axis reading.
														  //    else
														     //   motor[motorG] = joystick.joy1_y2*2/3;
														    }
														    else                                    // Else if the readings are within the threshold:
														    {
														      motor[motorH] = 0;                        // Motor B is stopped with a power level of 0.
														    }
														    ...
														    {
														  //   if (direction)
														      motor[motorI] = -joystick.joy1_y1;         // Motor C is assigned a power level equal to the left analog stick's Y-axis reading.
														 //   else
														 //     motor[motorF] = joystick.joy1_y1*2/3;
														    }
														    else                                    // Else if the readings are within the threshold:
														    {
														      motor[motorI] = 0;                        // Motor C is stopped with a power level of 0.
														    }
											  }
